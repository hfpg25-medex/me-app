...
function FeaturesSection() {
  ...
  return (
    <section className="py-12 md:py-20 bg-gray-50">
      <div className="container mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-bold text-center mb-8 md:mb-12">Why Choose Our Portal?</h2>
    ...
    <section id={id} className="bg-white py-12 md:py-20">
      <div className="container mx-auto px-4">
        <div className="max-w-md mx-auto">
          <h2 className="text-2xl md:text-3xl font-bold text-center mb-6 md:mb-8">Log into Your Account</h2>
          <LoginForm />
        </div>
      </div>
    </section>
