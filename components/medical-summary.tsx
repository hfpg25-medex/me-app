                ...
                <div key={item.condition} className="space-y-1">
                  <div className="flex items-start align-middle justify-between gap-4">
                    <div className="space-y-1">
                      <div className="text-sm align-middle text-gray-500">{item.condition}</div>
                      {item.hasCondition && item.details && (
                        <div className="mt-1">{item.details}</div>
                      )}
                    </div>
                    <div className={`w-12 text-right ${item.hasCondition ? 'text-red-500 font-medium' : ''}`}>
          ...
          <Card className="p-4">
            ...
            <div className="space-y-3 text-md">                          
              <div>
                ...
                <div className={tests.radiological.result === 'abnormal' ? 'text-red-500' : ''}>
              ...
              <div>
                ...
                <div className={tests.syphilis === 'positive' ? 'text-red-500' : ''}>
                  {tests.syphilis === 'positive' ? 'Positive' : 'Negative'}
                </div>
              </div>
              <div>
                <div className="text-gray-500 text-sm">Blood film for Malaria</div>
                <div className={tests.malaria === 'positive' ? 'text-red-500' : ''}>
              ...
              <div>
                ...
                <div className={tests.hba1c === 'abnormal' ? 'text-red-500' : ''}>
                  {tests.hba1c === 'abnormal' ? 'Abnormal' : 'Normal'}
                </div>
              </div>
              <div>
                <div className="text-gray-500 text-sm">Blood lipids</div>
                <div className={tests.lipids === 'abnormal' ? 'text-red-500' : ''}>
          ...
          <Card className="p-6">
            <div className="space-y-6">
              ...
              <div>
                ...
                <SectionHeader title="Clinic & doctor details" onEdit={() => handleEdit('clinic-doctor')} />
                  <div>
